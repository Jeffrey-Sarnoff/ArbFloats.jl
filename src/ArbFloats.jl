...
export ArbFloat,      # co-matched decimal rounding, n | round(hi,n,10) == round(lo,n,10)
       ...
       iszero, ntzero, nonzero, isone, ntone, isinteger, ntinteger,
       ispositive, isnonpositive, nisnegative, isnonnegative,
       areequal, arenotequal, overlap, donotoverlap, contains, doesnotcontain,
